...
exports.help = {
    name: "pcorona",
    description: `${config.prefix}pcorona (AU, BR, CN, DE, DK, ES, FI, FR, IE, IS, IT, NO, PL, PT, RU, SE, SZ, TR ou US) mostra estatísticas do corona vírus nos países: Austrália, Brasil, China, Alemanha, Dinamarca, Espanha, Finlândia, França, Irlanda, Islândia, Itália, Noruega, Polônia, Portugal, Rússia, Suécia, Suíça, Turquia e EUA respectivamente, veja ainda o ${config.prefix}corona e o ${config.prefix}ncorona`
}