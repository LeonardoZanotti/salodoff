...
exports.help = {
    name: "corona",
    description: `Mostra estatísticas globais sobre o corona vírus (https://thevirustracker.com/), veja ainda o \`${config.prefix}coronanews\` e o \`${config.prefix}coronapaís\``
}